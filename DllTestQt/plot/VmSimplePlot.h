...
public:
    ...
    Q_INVOKABLE double getAxisInterval(int k){return Axis::AxisInterval[k];};
    ...
    Q_INVOKABLE void updatDevState(int devstate);
    Q_INVOKABLE void updateDatas(int real_length, int sample/*QVariantList list*/);
